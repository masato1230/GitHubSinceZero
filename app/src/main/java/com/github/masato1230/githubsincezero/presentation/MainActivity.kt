...
import com.github.masato1230.githubsincezero.presentation.screens.home.HomeScreen
import com.github.masato1230.githubsincezero.presentation.screens.userdetail.UserDetailScreen
                        ...
                        composable<AppRoute.UserDetail> { backEntry ->
                            UserDetailScreen(
                                ...
                                onClickXAccount = { accountId ->
                                    val url = "${GitHubSinceZeroConstants.X_BASE_URL}$accountId/"
